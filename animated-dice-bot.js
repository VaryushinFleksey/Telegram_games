...
async function selectRandomToxic(chatId) {
    try {
        ...
        if (memberCount > 0) {
            // Создаем список случайных имен участников
            const randomNames = [
                'Алексей', 'Мария', 'Дмитрий', 'Анна', 'Сергей', 'Елена', 'Андрей', 'Ольга',
                'Владимир', 'Татьяна', 'Игорь', 'Наталья', 'Михаил', 'Ирина', 'Николай', 'Светлана',
                'Павел', 'Юлия', 'Артем', 'Катерина', 'Роман', 'Алиса', 'Денис', 'Виктория',
                'Максим', 'Полина', 'Александр', 'София', 'Кирилл', 'Ангелина', 'Даниил', 'Валерия'
            ];
        ...
        // Если нет участников в статистике, создаем случайного
        const randomNames = ['Случайный участник', 'Неизвестный игрок', 'Тайный токсик'];
        const randomName = randomNames[Math.floor(Math.random() * randomNames.length)];
